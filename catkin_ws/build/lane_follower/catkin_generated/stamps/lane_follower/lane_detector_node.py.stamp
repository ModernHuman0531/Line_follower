...
class LaneDetectorNode:
    def __init__(self, use_video=False, video_path=None):
        ...
        self.hough_threshold = 40#20
        self.hough_min_line_length = 50#5
        self.hough_max_line_gap = 20#60
